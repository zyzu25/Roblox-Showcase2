            ...
            <div className="space-y-2.5">
              ...
              >
                <p className="text-[10px] text-white/40 leading-relaxed">
                  Partner status is earned by consistently referring paying clients. Rate is agreed on a case-by-case basis.
                </p>
              </div>
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-xs font-semibold mt-2 transition-all"
                style={{
                ...
                onMouseEnter={e => {
                  (e.currentTarget as HTMLAnchorElement).style.background = "rgba(251,191,36,0.22)";
                }}
                onMouseLeave={e => {
